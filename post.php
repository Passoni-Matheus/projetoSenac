...
$rs_post2 = mysqli_query($conn_bd_senac, $query_rs_post) or die(mysqli_error($conn_bd_senac));

$row_rs_post = mysqli_fetch_assoc($rs_post2);

$totalRow_rs_post = mysqli_num_rows($rs_post2);
...
<body class="container">
        ...
        <div class="col-xl-9 col-lg-7 col-md-7">
            <div class="container main-content flex">
                <div class="card img-fluid">
					<div>
                     <div class="card-body img-fluid col-12 col-sm-12 col-md-12 col-lg-12">
					   <section>
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-10 col-sm-10 col-10 <?php if($row_rs_publi['fotoPerfil'] == "aluno.png" || $row_rs_publi['fotoPerfil'] == "aluna.png") {
						echo("nome-usuario-2"); 
							}
						  else { 
							  echo("nome-usuario"); 
							...
							<a class="link-post" id="link_post" title="">
								...
								<section>
									<h3 class="fonte-zero col-md-12">Imagem - <?php echo($row_rs_publi['fotoThumb'])?></h3>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-5 font-center"><a href="vote.php?idPost=<?php echo($row_rs_post['idPost'])?>"><img src="imagens/vote.png" width="28" height="28" title="Vote"></a></div>
									
                                <div class="col-xl-6 col-lg-6 col-md-6 col-7 font-center"><a href="#"><img src="imagens/senac-logo-0 shareicon.png" title="Compartilhar" alt="Compartilhar" width="33" height="28"></a></div>
								</div>
	...
	mysqli_free_result($rs_post2);
 	mysqli_free_result($rs_publi);

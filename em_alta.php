                ...
                <div class="card">
                    <div class=" card-header top-bar header-top">
                        <div class="row barra">
							...
							<div class="col-xl-4 col-lg-4 col-md-5 col-sm-5 col-5 ctr"><a href="index.php" style="color: #4872ab; text-decoration: none" class="mudar !important">Para você</div></a>
							<div class="col-xl-2 col-lg-4 col-md-2 col-sm-2 col-2 ctr">|</div>
							<div class="col-xl-4 col-lg-4 col-md-5 col-sm-5 col-5 ctr"><a href="em_alta.php" style="color: #ffad5a; text-decoration: none" class="mudar !important">Em Alta</div></a>
							<div class="col-xl-1"></div>
						</div>
						</div>
                    </div>

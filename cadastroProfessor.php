	...
	//fim verificação email repetido
		...
		if($_POST['genero'] == "2"){
			$fotoPerfil = "professora.png";
		} else {
			$fotoPerfil = "professor.png";
		}
	...
	// inicio cadastro
	$query_rs_cadastrar = "INSERT INTO tb_usuarios (idUsuario, dataCad, nome, fotoPerfil, email, senha, posto, idUf, suspenso, telefone, nascimento, idGenero, informacoes, ip) VALUES (NULL, 'current_timestamp()', '$nome', '$fotoPerfil', '$email', '$senha', '1', '$idUf', '0', '$telefone', '', '$genero', '', '');";
	...
	<title>SenacChat - Cadastro Professor</title>
	...
	<h1 class="fonte-zero">SenacChat - Cadastro Professor</h1>
...
instituíção.</div>
		...
		<h2 class="login-professor-titulo"> Cadastro Docente </h2>
		
		<p>Já possui conta?</p>
		<a class="btn btn-success" href="preLogin.php" role="button">Faça Login</a>
		<br><br>
		...
		<form method="post" enctype="multipart/form-data">
			...
			<label for="nome">Nome *</label>
			<br>
		  <input class="col-12" name="nome" type="text" required="required" id="nome" placeholder="" size="40">
			<br><br>
		  ...
		  <label for="email">Digite seu Email *</label>
			<br>
		  <input class="col-12" name="email" type="email" required="required" id="email" placeholder="digite seu email" size="40">
			<br><br>
		<!--	<label for="nome">Código de Professor:</label>
			<br>
		  <input name="posto" type="text" id="posto" placeholder="" size="40">
			<p style="font-size: 12px">PS: Ignore o campo se você não tiver o código.</p>-->
			
		  <label for="idUf">Estado: </label><br>
			<select class="col-12" name="idUf" id="idUf" required>
				<?php do {?>
			<option class="col-11" value="<?php echo($row_rs_uf['idUf'])?>"><?php echo($row_rs_uf['estado'])?></option>
				<?php } while($row_rs_uf = mysqli_fetch_assoc($rs_uf));?>
			</select>
			<br><br>
		  ...
		  <label for="senha">Digite sua senha *</label>
			<br>
		  <input class="col-12" name="senha" type="password" required="required" id="senha" placeholder="digite sua senha" size="40">
			<br><br>
			
			<label for="senhaconfirmar">Confirme sua senha *</label>
			<br>
		  <input class="col-12" name="senhaconfirmar" type="password" required="required" id="senhaconfirmar" placeholder="confirme sua senha" size="40" >
			<br><br>

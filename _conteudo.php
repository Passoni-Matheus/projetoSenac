...
<h2 class="fonte-zero">Publicações</h2>
			<?php do { ?>
				   <div class="card-body">
					   <section>
                        <div class="row">
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1 imagem-usuario"><img class="rounded-circle" src="<?php echo($icones.$row_rs_post['fotoPerfil']) ?>" alt="" width="44px"></div>
						...
						echo("nome-usuario-2"); 
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 data"><?php echo($row_rs_post['dataCad'])?></div>
							...
							<a href="post.php?idPost=<?php echo($row_rs_post['idPost'])?>" class="link-post" id="link_post" title="<?php echo($row_rs_post['titulo'])?>">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 font-center"><a href="#"><img src="imagens/vote.png" width="25" height="25" title="Vote"></a></div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 font-center"><a href="#"><img src="imagens/senac-logo-0 shareicon.png" title="Compartilhar" alt="Compartilhar" width="25" height="20"></a></div>     
                        </div>
						 	</a> 
					   		  </section>	   
                    			</div>
